...
## 📄 Abstract
This study investigates the divergence in public discourse regarding "Agentic AI." By analyzing **19,250 Reddit posts** from late 2025, we identify a "Builder-Worker Paradox," where technical practitioners exhibit neutral frustration regarding operational friction, while the general workforce exhibits high levels of existential anxiety. The study employs a mixed-methods approach combining **BERTopic** modeling, **GoEmotions** affective analysis (RoBERTa), and qualitative coding.
